...
export const PERMISSIONS = {
  ...
  'transaction:read': [ROLES.READONLY, ROLES.MEMBER, ROLES.ACCOUNTANT, ROLES.ADMIN, ROLES.OWNER],
  'transaction:create': [ROLES.MEMBER, ROLES.ACCOUNTANT, ROLES.ADMIN, ROLES.OWNER],
  'transaction:update': [ROLES.ACCOUNTANT, ROLES.ADMIN, ROLES.OWNER],
  'transaction:delete': [ROLES.ADMIN, ROLES.OWNER],

  // Account permissions
  'account:read': [ROLES.READONLY, ROLES.MEMBER, ROLES.ACCOUNTANT, ROLES.ADMIN, ROLES.OWNER],
  'account:create': [ROLES.ADMIN, ROLES.OWNER],
  'account:update': [ROLES.ADMIN, ROLES.OWNER],
  'account:delete': [ROLES.OWNER],

  // Budget permissions
  'budget:read': [ROLES.READONLY, ROLES.MEMBER, ROLES.ACCOUNTANT, ROLES.ADMIN, ROLES.OWNER],
  ...
  'document:read': [ROLES.READONLY, ROLES.MEMBER, ROLES.ACCOUNTANT, ROLES.ADMIN, ROLES.OWNER],
  'document:upload': [ROLES.MEMBER, ROLES.ACCOUNTANT, ROLES.ADMIN, ROLES.OWNER],
  ...
  // Rule permissions
  'rule:read': [ROLES.READONLY, ROLES.MEMBER, ROLES.ACCOUNTANT, ROLES.ADMIN, ROLES.OWNER],
  'rule:manage': [ROLES.ACCOUNTANT, ROLES.ADMIN, ROLES.OWNER],

  // Member permissions
  'member:read': [ROLES.READONLY, ROLES.MEMBER, ROLES.ACCOUNTANT, ROLES.ADMIN, ROLES.OWNER],
  'member:invite': [ROLES.ADMIN, ROLES.OWNER],
  'member:update': [ROLES.ADMIN, ROLES.OWNER],
  'member:remove': [ROLES.OWNER],

  // Workspace permissions
  'workspace:read': [ROLES.READONLY, ROLES.MEMBER, ROLES.ACCOUNTANT, ROLES.ADMIN, ROLES.OWNER],
  'workspace:update': [ROLES.ADMIN, ROLES.OWNER],
  'workspace:delete': [ROLES.OWNER],

  // Pro mode permissions
  'pro:read': [ROLES.READONLY, ROLES.MEMBER, ROLES.ACCOUNTANT, ROLES.ADMIN, ROLES.OWNER],
