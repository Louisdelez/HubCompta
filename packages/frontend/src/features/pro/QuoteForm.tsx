    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="mb-6">
        ...
        <p className="text-ctp-subtext0">
          {isEditing ? 'Modifiez les lignes du devis' : 'Creez un nouveau devis'}
        </p>
      </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="card">
              ...
              <textarea
                ...
                placeholder="Conditions, delais de validite..."
              />
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <button
                ...
                disabled={isPending}
              >
                {isPending ? 'Enregistrement...' : isEditing ? 'Mettre a jour' : 'Creer le devis'}
              </button>
              <button
                type="button"
                onClick={() => navigate(-1)}
