...
const notificationTypeConfig: Record<string, NotificationTypeConfig> = {
  ...
  budget_alert: {
    ...
    category: 'alerts',
    actionUrl: (data) => data?.budgetId ? `/budgets/${data.budgetId}` : '/budgets',
  },
  budget_warning: {
    icon: AlertTriangle,
  ...
  low_balance_warning: {
    ...
    category: 'alerts',
    actionUrl: (data) => data?.accountId ? `/accounts/${data.accountId}` : '/accounts',
  },
  unusual_spending: {
    icon: AlertTriangle,
    color: 'text-ctp-peach',
    borderColor: 'border-l-ctp-peach',
    category: 'alerts',
    actionUrl: (data) => data?.transactionId ? `/transactions/${data.transactionId}` : '/transactions',
  },
  price_alert: {
    icon: TrendingUp,
    color: 'text-ctp-blue',
  ...
  savings_milestone: {
    ...
    category: 'savings',
    actionUrl: (data) => data?.goalId ? `/savings/${data.goalId}` : '/savings',
  },
  savings_off_track: {
    icon: Target,
  ...
  invoice_overdue: {
    ...
    borderColor: 'border-l-ctp-red',
    category: 'other',
    actionUrl: (data) => data?.invoiceId ? `/invoices/${data.invoiceId}` : '/invoices',
  },
  invoice_paid: {
    icon: CheckCircle,
    color: 'text-ctp-green',
